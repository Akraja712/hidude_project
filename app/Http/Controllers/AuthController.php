...
class AuthController extends Controller
{
    ...
    public function register(Request $request)
    {
        ...
        $users->coins = 20; // Add default coins
        $users->total_coins = 20; // Add default total coins
...
public function add_coins(Request $request)
{
    ...
    $order->status = 1;                  // Status set to 1
    $order->price = $price;              // Use coins price
    ...
    return response()->json([
        'success' => true,
        'message' => 'Coins added successfully, and order created.',
        'data' => [
            'name' => $user->name,
...
public function try_coins(Request $request)
{
    ...
    $order->user_id = $user_id;
    $order->coins_id = $coins_id;
    $order->status = 0;                  // Status set to 1
    $order->price = $price;              // Use coins price
    $order->datetime = now();            // Current timestamp
